...
export default function Lot() {
     ...
     .then(data => {
         ...
         for (i in data)
         {
           ...
           else if(data[i]==1)
           {
            obj=document.getElementById(i)
            obj.style.color="black"
            obj.style.border="3px solid #6f4d4d"
  ...
  return (
    <div id="slot">
      ...
      <button style={{border:"2px solid #90EE90",marginLeft:"15px",backgroundColor:"#90EE90",color:"#90EE90"}}>0</button>
      <span style={{marginLeft:"7px",color:"green",fontSize:"25px"}}> Available</span>
      <br></br>
      <br></br>
      <button style={{border:"2px solid #daa8a8",color:"#daa8a8",marginLeft:"15px",backgroundColor:"#daa8a8"}}>0</button>
      <span style={{marginLeft:"10px",color:"orange",fontSize:"25px"}}>Not Available</span>
      <div id="master">
